...
<div class="wrapper">
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="inputGroup inputGroup1">
            <label for="loginEmail" id="loginEmailLabel">Cuenta</label>
            <input type="text" id="loginEmail" name="username" maxlength="254" required autocomplete="off"/>
...
{{--<script src="{{ url('js/MorphSVGPlugin.min.js') }}"></script>--}}
<script src="https://cdn.jsdelivr.net/npm/kute.js@1.6.6/kute.js"></script>
