...
<head>
    ...
    <title>Imprimir Carga Académica</title>
    <style>
        @charset "UTF-8";
        /*!
 *   AdminLTE v3.0.2
 ...
 */
        ...
        *::after {
        ...
        .sidebar-mini .main-sidebar:not(.sidebar-no-expand):hover .nav-legacy.nav-compact > .nav-item > .nav-link.a
...
<div class="row1">
    <div class="column">
        <h2 class="card-title">SGMI</h2>
    </div>
    <div class="column1">
        <p class="card-text">Periodo: {{$cargaAcademica[0]->periodo}}</p>
    </div>
    <div class="column1">
        <p class="card-text">Carrera: {{$cargaAcademica[0]->carrera->nombre_carrera}}</p>
    </div>
</div>
<div class="row">
